...
<body>
  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover" style="background-image: url('a.jpg');">
      <div class="container">
        <div class="row">
          <div class="col-lg-14 mx-auto order-lg-2 align-self-center">
            <div class="site-block-cover-content text-center">
              <h2 class="sub-title">We have more than a thousand cars for you to choose.</h2>
              <h1>RELAXED JOURNEY EVER</h1>
              <p>
                <a href="carlist.php" class="btn btn-primary px-5 py-3">Rent Car Now</a>
              </p>
            </div>
          </div>
        </div>
